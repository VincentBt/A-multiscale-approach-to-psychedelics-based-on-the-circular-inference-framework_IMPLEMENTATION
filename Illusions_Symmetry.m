%%% Illusions / Mental Imagery / Prior-driven Hallucinations
%%% Symmetrical
...
for rep = 1:Nrep-1
    ...
    BL5(rep+1) = ML4L5(rep) + ML6L5(rep);
    BL6(rep+1) = ML5L6(rep) + ML7L6(rep);
    BL7(rep+1) = ML6L7(rep) + MSL;
    ...
    ML6L5(rep+1) = F(BL6(rep+1) - (ad * ML5L6(rep)),ws1,ws0);
    ML5L6(rep+1) = F(BL5(rep+1) - (ac * ML6L5(rep)),wp1,wp0);
    ML7L6(rep+1) = F(BL7(rep+1) - (ad * ML6L7(rep)),ws1,ws0);
    ML6L7(rep+1) = F(BL6(rep+1) - (ac * ML7L6(rep)),wp1,wp0);
...
bL6i = exp(BL6)./(1+exp(BL6));
bC7i = exp(BC7)./(1+exp(BC7));
bL7i = exp(BL7)./(1+exp(BL7));
...
bL6d = exp(BL6)./(1+exp(BL6));
bC7d = exp(BC7)./(1+exp(BC7));
bL7d = exp(BL7)./(1+exp(BL7));
...
bL6c = exp(BL6)./(1+exp(BL6));
bC7c = exp(BC7)./(1+exp(BC7));
bL7c = exp(BL7)./(1+exp(BL7));


%% FIGURES
figure(1) % Descending Loops
subplot(1,2,1)
bar([1,2],[bC4i(end),bC4d(end)],'LineWidth',3)
hold on
...
xlim([0,3])
subplot(1,2,2)
bar([1,2],[bL4i(end),bL4d(end)],'LineWidth',3)
hold on
plot([0,3],[0.5,0.5],'k--','LineWidth',2)
hold off
ylim([0 1])
...
subplot(1,2,1)
bar([1,2],[bC4i(end),bC4c(end)],'LineWidth',3)
hold on
plot([0,3],[0.5,0.5],'k--','LineWidth',2)
hold off
ylim([0 1])
xlim([0,3])
subplot(1,2,2)
bar([1,2],[bL4i(end),bL4c(end)],'LineWidth',3)
hold on
plot([0,3],[0.5,0.5],'k--','LineWidth',2)
hold off
ylim([0 1])
